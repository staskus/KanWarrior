...
module.exports.controller = function (app) {
    ...
    app.get('/', function (req, res) {
        ...
        var calendarList = app.locals.calendars;
        if (app.locals.first == 1) {
            app.locals.calendars = null;
            app.locals.first = 0;
        }
        ...
        taskManager.getAllTasks((taskArray)=> {
            ...
            sortTasks(tasks);
            res.render('index.ejs', {tasks: tasks, projects: projects, tags: tags, calendars: calendarList});
        });
    });
    ...
    app.post('/sync', urlencodedParser, function (req, res) {
        ...
        //callDAVWrap.sendCalendars();
        callDAVWrap.getCalendars(function (lists) {
            app.locals.calendars = lists;
            app.locals.first = 1; // crappy workaround
            res.redirect('/');
        });
    });
