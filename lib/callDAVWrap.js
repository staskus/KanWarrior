...
Wrapper.prototype.editTask = function (task, authorization) {

    var calendarURI = authorization.uri;//'https://dav.fruux.com/calendars/a3298237652/31d8603d-1f28-46f9-a440-cafe8dd38b53/';
    ...
    var config = {
        auth: {
            user: authorization.user,//'b3297510659',
            pass: authorization.pass//'62hz43n0jw5q'
        },
        uri: taskURI
    };
...
Wrapper.prototype.sendTask = function (task, authorization) {

    var calendarURI = authorization.uri;
    var taskURI = calendarURI + task.uuid + '.ics';
...
Wrapper.prototype.getTasks = function (authorization, call) {
