...
var update = exports.update = function update(tasks) {
    ...
    for (i = 0; i < tasks.length; i++) {
        ...
        if (t.start != null) {
            //if (!tagExists(t, done))
            //    if (!tagExists(t, inProgress)) //if it does not have inProgress tag
            //        addTag(t, inProgress);//add inProgress tag
        }
...
var editTask = exports.editTask = function editTask(id, description, due, priority, project, tags, status) {
