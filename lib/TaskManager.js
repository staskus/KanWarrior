...
var update = exports.update = function update(tasks) {
    ...
    for (i = 0; i < tasks.length; i++) {
        ...
        //if(t.id == 2)
        //console.log(`TASKAS1:  ${t.id} ${t.description} project:${t.project} tags:${t.tags} ${t.start}`);
        removeUnneededTags(t); // remove those kw tags that were assigned in taskwarrior and are not needed for kw
        //if(t.id == 2)
        //console.log(`TASKAS2:  ${t.id} ${t.description} project:${t.project} tags:${t.tags} ${t.start}`);
        prepareStartTask(t); // check if task is started and adjust tags if is needed
        //if(t.id == 2)
        //console.log(`TASKAS3:  ${t.id} ${t.description} project:${t.project} tags:${t.tags} ${t.start}`);
