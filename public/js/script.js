...
window.onload = function () {
    ...
    //for non reloading page (incomplete) :
    ...
    //    status : 'pending',
    //    entry : getCurrentDate(),
    //    due : document.getElementById('add_task_due_date').value,
    //    priority : document.getElementById('add_task_priority').value,
    //    project : document.getElementById('add_task_project').value,
    //    tags : document.getElementById('add_task_tags').value,
    //    parent : 'board_1',
